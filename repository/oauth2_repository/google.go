...
func (o *Oauth2RepositoryImpl) GetGoogleToken(code string) (*repository.Oauth2GoogleToken, error) {
	...
	googleOauthToken := repository.Oauth2GoogleToken{
...
func (o *Oauth2RepositoryImpl) GetGoogleUser(token *repository.Oauth2GoogleToken) (*repository.Oauth2GoogleUser, error) {
	...
	userBody := &repository.Oauth2GoogleUser{

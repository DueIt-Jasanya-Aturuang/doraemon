...
func TestOauth2HandlerLoginWithGoogle(t *testing.T) {
	...
	t.Run("ERROR_claim-user_repository-invalid-token", func(t *testing.T) {
		...
		oauth2Usecase.GoogleClaimUser(context.TODO(), req)
		oauth2Usecase.GoogleClaimUserReturns(nil, _error2.ErrStringDefault(http.StatusForbidden))
	...
	t.Run("ERROR_when-register", func(t *testing.T) {
		...
		authUsecase.Register(context.TODO(), &dto.RegisterReq{})
		authUsecase.RegisterReturns(nil, _error2.ErrStringDefault(http.StatusInternalServerError))

...
var InvalidAppID = errors.New("invalid app_repository id")
...
var InvalidEmailOrOTP = errors.New("invalid email atau otp_usecase")
var InvalidToken = errors.New("invalid Token")
var TokenExpired = errors.New("access_repository Token expired")
